...
training.train_network(model=model,lr=lr,max_epochs=max_epochs,steps_per_epoch=steps_per_epoch,directory_path=directory_path,
                    #    train_loader=train_loader,val_loader=val_loader,test_loader=test_loader,
                       ...
                       model_name=model_name,val_loss_patience=100, debug=debug, save_output=save_output, project_name=project, batch_size=batch_size, cl_w = 1e-1, kl_w = 10)
