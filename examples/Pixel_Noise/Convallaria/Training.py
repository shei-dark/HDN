...
for key in tqdm(keys, desc="Filtering data"):
    train_images[key], train_labels[key] = boilerplate._filter_slices(
        train_images[key], train_labels[key]
    )
    val_images[key], val_labels[key] = boilerplate._filter_slices(
...
model_name = "HVAE"
directory_path = "/group/jug/Sheida/HVAE/2D/5x5_5x5"
# directory_path = "./test/"
# Data-specific
