...
for test_index in tqdm(img_idx):
    ...
    for model_v in model_versions:
        ...
        os.makedirs("/group/jug/Sheida/HVAE/segmentation/seg/", exist_ok=True)
        tiff.imwrite(f"/group/jug/Sheida/HVAE/segmentation/seg/{model_v}_{test_index}_sup.tif", clusters.astype(np.uint8))
